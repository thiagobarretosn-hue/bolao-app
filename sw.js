...
self.addEventListener('fetch', e => {
  ...
  if (u.origin !== location.origin) return;   // não intercepta o app (Google)

  // Documento de navegação (index.html) → network-first: pega a versão nova;
